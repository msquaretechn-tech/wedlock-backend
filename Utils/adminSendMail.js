...
const sendAdminInfoEmail = async ({ email, subject, template, data }) => {
    ...
    console.log(`SMTP_MAIL: ${process.env.SMTP_ADMIN_MAIL}`);
    console.log(`SMTP_PASSWORD: ${process.env.SMTP_ADMIN_PASSWORD}`); // Masked password
...
export default sendAdminInfoEmail;
